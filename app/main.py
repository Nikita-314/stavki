...
async def main() -> None:
    ...
    await bot.set_my_commands(
        [
            ...
            BotCommand(command="auto_signal_status", description="Статус автосигналов"),
            BotCommand(command="auto_signal_run_once", description="Запустить один цикл автосигналов"),
            BotCommand(command="signal_status", description="Статус направлений сигналов"),
            BotCommand(command="signal_pause", description="Поставить сигналы на паузу"),
            BotCommand(command="signal_start", description="Снять паузу сигналов"),
            BotCommand(command="signal_football", description="Переключить футбол"),
